...
Marketing site and blog for **Tech-Agnostic** — an independent IT consultancy.

- **`apps/web`** — Next.js 16 (App Router, TypeScript, Tailwind v4). Landing page,
  conversion funnel, three-step lead form. No backend.
- **`apps/blog`** — Astro 5 static blog, compiled into `apps/web/public/blog` so a
...
- Duotone base (ink + paper), **one** accent (`--ta-signal` orange), one
