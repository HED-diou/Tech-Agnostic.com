...
export default function PrivacyPage() {
  return (
    <section className="container-ta py-20 lg:py-28">
      ...
      <div className="mt-16 divide-y divide-ink-600 border-t border-ink-600">
        {sections.map((section) => (
          ...
          >
            ...
            <p className="text-steel-400 measure">{section.body}</p>
          </div>
        ))}
      </div>
      ...
      <p className="mt-10 font-mono text-xs text-steel-400">
